...
int main()
{
    ...
    ll n,d;cin>>n>>d;
    ll x,y;
    auto line=[=,&x,&y](ll a,ll b,ll c){ return a*x + b*y +c;};
    auto l1=[=](){  return line(-1,1,0); };
    auto l2=[=](){  return line(1,1,0 ); };
    auto inClosedRange=[](ll x, ll l, ll r){ if(r<l) swap(l,r); return x>=l && x<=r;};
    ll m;cin>>m;
    rep(i,0,m)
    {
        cin>>x>>y;
        ...
        bool flg=false;
        if( inClosedRange(l1(),-d,d) && inClosedRange(l2(),d,2*n -d) ) flg=true;
